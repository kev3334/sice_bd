...
--SCRIPT REDES
ALTER TABLE REDES
DROP (codredsgh, codredgcaa, n_iddependencia, codredsap, codredsgss);

ALTER TABLE REDES
RENAME COLUMN REDSGH TO DESCRIPCION;

ALTER TABLE REDES
MODIFY DESCRIPCION VARCHAR2(100);

ALTER TABLE REDES
MODIFY TIPO_RED VARCHAR2(5);

ALTER TABLE REDES
MODIFY ACTIVO NUMBER(1,0);

--SCRIPT CENTROS

ALTER TABLE CENTROS
DROP (COD_CENTROSGH, OFERTA, TIPO_OFERTA_EXTRAINST, NIVEL_TMI, COD_CENTRO_SAP, LATITUD, LONGITUD);

ALTER TABLE CENTROS
DROP (ACTIVO);

ALTER TABLE CENTROS
RENAME COLUMN DESCRIPCIONSGH TO SUBNIVEL;

ALTER TABLE CENTROS
RENAME COLUMN TIPO_NIVEL TO CATEGORIA;

ALTER TABLE CENTROS
RENAME COLUMN DESCRIPCION_NIVEL TO IDESTABL;

ALTER TABLE CENTROS
RENAME COLUMN CODIGO_RENIPRESS TO ACTIVO;

ALTER TABLE CENTROS
MODIFY SUBNIVEL VARCHAR2(5);

ALTER TABLE CENTROS
MODIFY NIVEL VARCHAR2(10);

ALTER TABLE CENTROS
MODIFY CATEGORIA VARCHAR2(25);

ALTER TABLE CENTROS
MODIFY IDESTABL VARCHAR2(4);

ALTER TABLE CENTROS
MODIFY ACTIVO NUMBER(1,0);

--SCRIPT UNIDAD_PRODUCTORA_SERVICIOS

ALTER TABLE UNIDAD_PRODUCTORA_SERVICIOS
ADD DESCRIPCION VARCHAR2(80);

ALTER TABLE UNIDAD_PRODUCTORA_SERVICIOS
ADD ESTADO NUMBER(1,0);

--SCRIPT INSUMOS_MEDICOS

ALTER TABLE INSUMOS_MEDICOS
ADD T_MATERIAL VARCHAR2(5);

ALTER TABLE INSUMOS_MEDICOS
ADD GRUPO_MATERIAL CHAR(5);

ALTER TABLE INSUMOS_MEDICOS
ADD UNIDAD_MEDIDA VARCHAR2(5);

ALTER TABLE INSUMOS_MEDICOS
ADD DESCRIPCION_CATEGORIA VARCHAR2(70);

ALTER TABLE INSUMOS_MEDICOS
ADD CTA_CONTABLE CHAR(10);

ALTER TABLE INSUMOS_MEDICOS
ADD CTA_COMPMRAS CHAR(10);

ALTER TABLE INSUMOS_MEDICOS
ADD CTA_STOCK CHAR(10);

ALTER TABLE INSUMOS_MEDICOS
RENAME COLUMN CTA_COMPMRAS TO CTA_COMPRAS;

--SCRIPT EQUIPAMIENTOS
ALTER TABLE equipamientos  
ADD MARCA VARCHAR2(50);

ALTER TABLE equipamientos  
ADD CTA_CONTABLE CHAR(10);

ALTER TABLE TIPOS_DE_EQUIPAMIENTOS
MODIFY ID_TIPO_EQUIPAMIENTO NUMBER(1,0);
